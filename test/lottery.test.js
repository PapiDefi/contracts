...
contract('Lottery', (accounts) => {
    it('init', async () => {
        ...
        this.papi = await MockBEP20.deployed();
        ...
        await this.papi.transfer(bob, '2000', { from: minter });
        await this.papi.transfer(alice, '2000', { from: minter });
        await this.papi.transfer(carol, '2000', { from: minter });
    });
    ...
    it('test', async () => {
        ...
        carol=accounts[3];
        dev=accounts[4];
        await this.papi.approve(this.lotteryProxyAddress, '1000', { from: alice });
        await this.papi.approve(this.lotteryProxyAddress, '1000', { from: bob });
        ...
        assert.equal((await this.papi.balanceOf(this.lotteryProxyAddress)).toString(), '418');
